...
#xzw_starSys .star{height:20px;width:120px;position:relative;background:url('http://localhost/share/materials/123.png') repeat-x;cursor:pointer}
...
#xzw_starSys .star li a:hover{background:url('http://localhost/share/materials/123.png') 0 -25px repeat-x;z-index:3;left:0}
...
#xzw_starSys .current-rating{background:url('http://localhost/share/materials/123.png') 0 -25px repeat-x;position:absolute;height:20px;z-index:1;top:0;left:0}
...
<div id="xzw_starSys">
    <div id="xzw_starBox">
        <ul class="star" id="star">
            <li><a href= "<?=pingke_url()?>/pingke_index/score/<?=$pig?>/1" title="1" class="one-star">1</a></li>
            <li><a href= "<?=pingke_url()?>/pingke_index/score/<?=$pig?>/2" title="2" class="two-stars">2</a></li>
            <li><a href= "<?=pingke_url()?>/pingke_index/score/<?=$pig?>/3"title="3" class="three-stars">3</a></li>
            <li><a href= "<?=pingke_url()?>/pingke_index/score/<?=$pig?>/4"title="4" class="four-stars">4</a></li>
            <li><a href= "<?=pingke_url()?>/pingke_index/score/<?=$pig?>/5"title="5" class="five-stars">5</a></li>
        </ul>
